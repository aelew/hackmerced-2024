...
const Summary = () => {
  ...
  return (
    ...
    <div className = 'summary-card' >
      <h1>Summary:</h1>
      <div className="grid">
        <div className={'card ' + status[0]}><Card icon = '🌻 Pollen Levels' text={'Pollen levels are very high in your area currently! Perpare for symptons and consider taking allergy medication. '}/></div>
        ...
        <div className="card"><Card icon = {safe ? '✅ It is Safe To Go Out!': '❌ It is not recommended to go out!'} text={'Based off of your inputs and our live calculations it is safe to be outside.'}/></div>
